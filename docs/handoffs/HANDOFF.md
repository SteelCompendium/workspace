...
| SC-284 | `sc284-cardhead-narrow` | `.superpowers/sdd/sc284-cardhead-narrow/` | **Needs Review**: dse `33b58c3` (on `619c4bd`), review-approved, gates green. Scott checks the stacked narrow card header at 300px (plus a small spacing question on "LEADER") and sanctions 6 print lines (`encounter-narrow`, `montage-narrow`, `statblock-sticky-narrow`, twin and realprint; `rebaseline.txt` in the ledger). |
...
| SC-317 | `sc317-extlink-icon` | `.superpowers/sdd/sc317-extlink-icon/` | **Needs Review**: dse `2897cc5` (on `619c4bd`), review-approved after 2 fix rounds, gates green, freeze 260/260, no rebaseline (the arrow is screen-only). Scott approves the external-link arrow's glyph, colour and gap. Spin-off SC-366. Its slot went to the SC-243 handback. |
