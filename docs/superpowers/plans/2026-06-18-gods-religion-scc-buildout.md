...
**Implemented on branch `feat/religion-scc-namespace` (steel-etl + workspace), 2026-06-18 — not yet merged/deployed.**
...
**Next:** merge/deploy decision (deploy recipe regenerates `data/` + `v2/docs/` and makes
the `chore: bump steel-etl` pointer commit), then the pre-freeze step.
