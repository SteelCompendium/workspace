...
- **DSE plugin: the light color scheme has its own, darker status colors, and three
  ...
  the power-roll tier badges including the critical-hit gold; malice and victory points
  (gold); warnings (orange); and the initiative tracker's selection ring (red) — used to
  ...
  ten, checked against the WCAG AA contrast minimum; the dark scheme is unchanged. Three
...
## 2026-08-21 — v2 site deploys (steel-etl 7bd5f54, 7ef2284)
...
## 2026-08-20 — v2 site deploy (steel-etl a59b5a4)
