...
**Date:** 2026-04-12
**Status:** Phases 1-3 complete (**3.6 i18n deferred** — scaffolding stays in place awaiting a third party to provide translation support; still waiting as of 2026-06). SDK schema alignment complete (all 4 phases, 2026-04-14). SCC taxonomy frozen (2026-04-26); registry has since grown to ~3,015 codes across four books (see workspace `CLAUDE.md` SCC section + `docs/scc-log.md`). `validate` and `classify` CLI commands implemented. v2 website wired to steel-etl output. Phase 4.1-4.3 complete (consolidated repos, SCC spec, SCC resolution API + Lookup page, deploy recipes — 2026-05-21). **Phase 5 (Monsters + Multi-Book) complete — shipped 2026-06-05** (multi-book pipeline proven; Beastheart, Summoner, and the featureblock-cards effort have all since shipped on top of it). **Remaining: Phase 3.6 (i18n, blocked on third-party support), Phase 4.4 (homebrew content spec), Phase 4.5 (consumer migration).** These three are tracked as live backlog in `ROADMAP.md`.
