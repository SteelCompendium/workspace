...
See [ARCHITECTURE.md](ARCHITECTURE.md) for the full pipeline: how content flows from annotated source markdown through `steel-etl` to the data repos and v2 website. Includes data flow diagrams, step-by-step deploy sequence, and what is safe to edit vs. generated.
