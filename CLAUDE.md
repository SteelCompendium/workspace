...
Registry is **~3,015 codes** across four books (heroes ~1,915, beastheart 242, monsters 632,
summoner ~225). `feature` is the umbrella type; companions/fixtures/summoner statblocks all
